import { DrawerDefault } from "../ui/drawer"

export const Navbar = () => {
    return (
        <nav className="text-primary h-12 w-full flex items-center justify-between px-5 py-1 shadow-lg">
            <div className="w-8 h-8">
                <svg id="logo" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 84 96">
                    <title>DaffaStack</title>
            ...
            <div>
                <DrawerDefault>
                    <div className="w-7 h-7 flex flex-col items-end justify-center space-y-0.5 cursor-pointer">
                        <span className="w-6 h-0.5 rounded-lg bg-primary" />
                        <span className="w-5 h-0.5 rounded-lg bg-primary" />
                        <span className="w-4 h-0.5 rounded-lg bg-primary" />
                    </div>
                </DrawerDefault>
            </div>
        </nav>
