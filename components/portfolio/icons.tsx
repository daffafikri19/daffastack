  ...
  <svg id="logo" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 84 96">
    ...
    <g transform="translate(-8.000000, -2.000000)">
      <g transform="translate(11.000000, 5.000000)">
        ...
        />
        <path
          d="M30.5,30.3 L40.1,30.3 C47.05,30.3 51.6,35 51.6,45.65 C51.6,56.3 47.05,61 40.1,61 L30.5,61 Z M35.8,34.95 L35.8,56.35 L39.7,56.35 C44.3,56.35 46.3,53.45 46.3,45.65 C46.3,37.85 44.3,34.95 39.7,34.95 Z"
          fill="currentColor"
        />
      </g>
    </g>
