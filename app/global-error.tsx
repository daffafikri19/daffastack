    ...
    <html lang="en">
      <body className="bg-background">
        <main className="flex min-h-screen items-center justify-center bg-background px-6 py-16">
          <section className="relative isolate w-full max-w-175">
            <div className="relative z-10 rounded-(--border-radius) border border-(--lightest-navy)/75 bg-(--light-navy) p-7 shadow-[0_10px_30px_-15px_var(--navy-shadow)] md:p-10">
              <p className="font-mono text-sm text-(--blue)">500</p>
              ...
              <p className="mt-4 max-w-xl text-[17px] leading-relaxed text-(--light-slate)">
                The application encountered an unexpected error. Please reload the page or return to the homepage.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link
                  href="/"
                  className="inline-flex items-center rounded-(--border-radius) border border-(--lightest-navy) px-5 py-2.5 font-mono text-sm text-(--light-slate) transition duration-200 hover:border-(--blue) hover:text-(--blue)"
                >
                  Back to Home
                </Link>
              </div>
